      ...
      <div className="section-wrap grid gap-8 pb-24 lg:grid-cols-[220px_1fr]">
        <aside className="glass-soft h-fit rounded-[2rem] p-5">
          ...
          <nav className="grid gap-1 text-sm">
            ...
            <Link className="rounded-xl px-3 py-2 text-stone-300 hover:bg-white/5" href="/admin/products#featured-items">Featured shelf</Link>
            ...
            <Link className="rounded-xl px-3 py-2 text-stone-300 hover:bg-white/5" href="/admin/business">Wholesale</Link>
